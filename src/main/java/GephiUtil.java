...
public class GephiUtil {
    public static void geph4j() throws IOException {
        BufferedReader br = new BufferedReader(new FileReader("part-r-00000.txt"));
        ...
        while((line = br.readLine())!= null){
            ...
            for (String namePair:nameList.split(";")){
                ...
                if (name_node == null){
                    ...
                    String new_label=find(name_value_pair[0]);
                    name_node.setLabel(name_value_pair[0])
                            .getAttributeValues()
                            .addValue(attUrl, new_label);
    ...
    private static String find(String s) throws IOException {
        BufferedReader br1 = new BufferedReader(new FileReader("part-r-00000.txt"));
        String str;
